...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/Fate2077/v2ray-poseidon-fork/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/Fate2077/v2ray-poseidon-fork/releases/latest"
